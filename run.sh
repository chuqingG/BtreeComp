...
./Benchmark -b insert,search -d ../../../datasets/random/*64B* -i 2 -n 100000000 -o auto -l 8 >> out.txt
./Benchmark -b insert,search -d ../../../datasets/random/*64B* -i 2 -n 100000000 -o auto -l 16 >> out.txt
